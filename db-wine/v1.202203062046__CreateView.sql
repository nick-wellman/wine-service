...
create or replace view wine_vw as select * from wine;
grant select, insert, update, delete on web.wine_vw to 'web_appl'@'localhost';
grant select, insert, update, delete on web.wine_vw to 'web_appl'@'%';
